...
module Docs
  class Protobuf < UrlScraper
    self.type = 'protobuf'
    self.links = {
      home: 'https://protobuf.dev',
      code: 'https://github.com/protocolbuffers/protobuf/'
    }
    self.base_url = 'https://protobuf.dev'
    self.root_path = 'programming-guides/proto2/'
    ...
    options[:attribution] = <<-HTML
      &copy; 2024&ndash;2024 Google, LLC.<br>
    HTML
...
#
    ...
    def get_latest_version(opts)
      get_npm_version('@protobuf/core', opts)
    end
